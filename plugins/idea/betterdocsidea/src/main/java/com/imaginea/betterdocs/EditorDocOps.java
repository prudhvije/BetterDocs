...
public class EditorDocOps {
    ...
    public final VirtualFile getVirtualFile(final CodeInfo codeInfo) {
        String tempDir = System.getProperty(JAVA_IO_TMP_DIR);
        String filePath = tempDir + "/" + codeInfo.toString();
        ...
        try {
            ...
            bufferedWriter.write(codeInfo.getContents());
